      ...
      populate: [
        {
          ...
          select:
            "minifigName pricePerBag piecesPerBag stock image colorId isActive badge category collectionIds partType",
          populate: [
    ...
    await addon.populate([
      {
        path: "bundleItems.inventoryItemId",
        select:
          "minifigName pricePerBag piecesPerBag stock image colorId badge category collectionIds partType",
        populate: [
          { path: "colorId", select: "colorName hexCode" },
          { path: "collectionIds", select: "collectionName" },
        ],
